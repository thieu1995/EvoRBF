#!/usr/bin/env python
# Created by "Thieu" at 10:42, 30/11/2024 ----------%
...
model = AdvancedRbfClassifier(center_finder="meanshift", finder_params={"bandwidth": 0.15},      # Give us 20 hidden nodes
                 rbf_kernel="inverse_multiquadric", kernel_params={"sigma": 1.5},
                 reg_lambda=0.5, has_bias=True, seed=42)

model = AdvancedRbfClassifier(center_finder="dbscan", finder_params={"eps": 0.2},      # Give us 119 hidden nodes
                 rbf_kernel="multiquadric", kernel_params={"sigma": 1.5},
                 reg_lambda=0.5, has_bias=True, seed=42)

model = AdvancedRbfClassifier(center_finder="dbscan", finder_params={"eps": 0.05},      # Give us 26 hidden nodes
                 rbf_kernel="multiquadric", kernel_params={"sigma": 1.5},
